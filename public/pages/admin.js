...
export default async function renderAdminPage(container, router) {
  ...
  shell.append(new MobileTopMenu({ router, mode: 'back', backPath: '/home' }), header, flash, tabs, usersPanel, categoriesPanel);
  mountDesktopLayout(page, shell, desktopSidebar);
  page.append(new MobileBottomNav({ router, activeKey: 'stats' }));
